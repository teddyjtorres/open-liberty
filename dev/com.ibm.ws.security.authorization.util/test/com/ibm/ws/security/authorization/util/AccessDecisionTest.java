...
public class AccessDecisionTest {
    ...
    public void unauthenticated_PermitAllOnClass_noAnnotationOnMethod() throws Exception {
        ...
        assertTrue(AccessDecision.isGranted(method(PERMITALL_ON_CLASS, "unannotated"),
                                            null,
                                            s -> {
                                                return true;
                                            }));
    ...
    public void denyAllOnClass_noAnnotationOnMethod() throws Exception {
        assertFalse(AccessDecision.isGranted(method(DENYALL_ON_CLASS, "unannotated"),
                                             principal("foo"),
                                             s -> {
                                                 return true;
                                             }));
    ...
    public void denyAllOnClass_denyAllOnMethod() throws Exception {
        assertFalse(AccessDecision.isGranted(method(DENYALL_ON_CLASS, "denyAll"),
                                             principal("foo"),
                                             s -> {
                                                 return true;
                                             }));
    ...
    public void denyAllOnClass_permitAllOnMethod() throws Exception {
        assertTrue(AccessDecision.isGranted(method(DENYALL_ON_CLASS, "permitAll"),
                                            principal("foo"),
                                            s -> {
                                                return true;
                                            }));
    ...
    public void denyAllOnClass_rolesAllowedOnMethod_inRole() throws Exception {
        assertTrue(AccessDecision.isGranted(method(DENYALL_ON_CLASS, "rolesAllowed"),
                                            principal("foo"),
                                            s -> {
    ...
    public void denyAllOnClass_rolesAllowedOnMethod_notInRole() throws Exception {
        assertFalse(AccessDecision.isGranted(method(DENYALL_ON_CLASS, "rolesAllowed"),
                                             principal("foo"),
                                             s -> {
    ...
    public void permitAllOnClass_denyAllOnMethod() throws Exception {
        assertFalse(AccessDecision.isGranted(method(PERMITALL_ON_CLASS, "denyAll"),
                                             principal("foo"),
                                             s -> {
                                                 return true;
                                             }));
    ...
    public void permitAllOnClass_permitAllOnMethod() throws Exception {
        assertTrue(AccessDecision.isGranted(method(PERMITALL_ON_CLASS, "permitAll"),
                                            principal("foo"),
                                            s -> {
                                                return true;
                                            }));
    ...
    public void permitAllOnClass_rolesAllowedOnMethod_inRole() throws Exception {
        assertTrue(AccessDecision.isGranted(method(PERMITALL_ON_CLASS, "rolesAllowed"),
                                            principal("foo"),
                                            s -> {
                                                return "role1".equals(s);
                                            }));
    ...
    public void permitAllOnClass_rolesAllowedOnMethod_notInRole() throws Exception {
        assertFalse(AccessDecision.isGranted(method(PERMITALL_ON_CLASS, "rolesAllowed"),
                                             principal("foo"),
                                             s -> {
                                                 return "role0".equals(s);
                                             }));
    ...
    public void rolesAllowedOnClass_in_noAnnotationOnMethod() throws Exception {
        assertTrue(AccessDecision.isGranted(method(ROLESALLOWED_ON_CLASS, "unannotated"),
                                            principal("foo"),
                                            s -> {
    ...
    public void rolesAllowedOnClass_notIn_noAnnotationOnMethod() throws Exception {
        assertFalse(AccessDecision.isGranted(method(ROLESALLOWED_ON_CLASS, "unannotated"),
                                             principal("foo"),
                                             s -> {
    ...
    public void rolesAllowedOnClass_denyAllOnMethod() throws Exception {
        assertFalse(AccessDecision.isGranted(method(ROLESALLOWED_ON_CLASS, "denyAll"),
                                             principal("foo"),
                                             s -> {
                                                 return true;
                                             }));
    ...
    public void rolesAllowedOnClass_permitAllOnMethod() throws Exception {
        assertTrue(AccessDecision.isGranted(method(ROLESALLOWED_ON_CLASS, "permitAll"),
                                            principal("foo"),
                                            s -> {
                                                return false;
                                            }));
    ...
    public void rolesAllowedOnClass_rolesAllowedOnMethod_inRole() throws Exception {
        assertTrue(AccessDecision.isGranted(method(ROLESALLOWED_ON_CLASS, "rolesAllowed"),
                                            principal("foo"),
                                            s -> {
    ...
    public void rolesAllowedOnClass_rolesAllowedOnMethod_notInRole() throws Exception {
        assertFalse(AccessDecision.isGranted(method(ROLESALLOWED_ON_CLASS, "rolesAllowed"),
                                             principal("foo"),
                                             s -> {
    ...
    public void noAnnotationsOnClass_noAnnotationOnMethod() throws Exception {
        assertTrue(AccessDecision.isGranted(method(NO_ANNOTATIONS_ON_CLASS, "unannotated"),
                                            principal("foo"),
                                            s -> {
                                                return true;
                                            }));
    ...
    public void noAnnotationsOnClass_denyAllOnMethod() throws Exception {
        assertFalse(AccessDecision.isGranted(method(NO_ANNOTATIONS_ON_CLASS, "denyAll"),
                                             principal("foo"),
                                             s -> {
                                                 return true;
                                             }));
    ...
    public void noAnnotationsOnClass_permitAllOnMethod() throws Exception {
        assertTrue(AccessDecision.isGranted(method(NO_ANNOTATIONS_ON_CLASS, "permitAll"),
                                            principal("foo"),
                                            s -> {
                                                return true;
                                            }));
    ...
    public void noAnnotationsOnClass_rolesAllowedOnMethod_inRole() throws Exception {
        assertTrue(AccessDecision.isGranted(method(NO_ANNOTATIONS_ON_CLASS, "rolesAllowed"),
                                            principal("foo"),
                                            s -> {
                                                return "role1".equals(s);
                                            }));
    ...
    public void noAnnotationsOnClass_rolesAllowedOnMethod_notInRole() throws Exception {
        assertFalse(AccessDecision.isGranted(method(NO_ANNOTATIONS_ON_CLASS, "rolesAllowed"),
                                             principal("foo"),
                                             s -> {
                                                 return "role0".equals(s);
                                             }));
